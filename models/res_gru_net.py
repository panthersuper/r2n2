...
from lib.layers import TensorProductLayer, ConvLayer, PoolLayer, Unpool3DLayer, \
    ...
    EltwiseMultiplyLayer, get_trainable_params, PrintShape
...
class ResidualGRUNet(Net):
    ...
    def network_definition(self):
        ...
        n_fc_filters = [1024]
        n_deconvfilter = [128, 128, 128, 64, 32, 3] #2 classes
        ...
        self.sym = softmax_loss.sym_loss(self.y)
        self.loc = softmax_loss.loc_loss()
        self.default_loss = softmax_loss.default_loss(self.y)
